...
import DialogContrato from "./contratoAdd"
...
export default () => {
  ...
  return (
    <>
      ...
      <DialogContrato open={open} handleClose={handleClose} title={"Agregar Contrato Adicional"} />
    </>
  )
}
