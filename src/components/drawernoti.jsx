    ...
    <div style={{ width: "300px" }}>
      <AppBar
        ...
        style={{
          ...
          color: "#000",
          boxShadow:
            "rgba(255, 255, 255, 0.2) 0px 2px 4px -1px, rgba(242, 239, 239, 0.14) 0px 4px 5px 0px, rgba(0, 0, 0, 0.12) 0px 1px 10px 0px"
        }}
      >
        <Toolbar variant="dense" style={{ minHeight: "61px" }}>
          <IconButton onClick={() => goTo(URL_PAGES.notificacion.path)} style={{ marginRight: "15px" }}>
