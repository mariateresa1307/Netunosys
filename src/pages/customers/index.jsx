...
import DetallesRegistro from "./modalDetalle"
        ...
        <Grid item xs={12} lg={12}>
          ...
          <Grid item xs={12} sm={6} md={4} lg={3}>
              <CustomCard
                ...
                background={"linear-gradient(to right, #0ec8d5, #00d7d4, #00e6cc, #00f3bc, #37ffa5)"}
                icons={<BarChartIcon />}
              />
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={4} lg={3}>
              <CustomCard
                ...
                background={"radial-gradient(circle at -20.71% 50%, #de9c2c 0, #e5922a 8.33%, #ea852b 16.67%, #ee772d 25%, #f16731 33.33%, #f35436 41.67%, #f23c3c 50%, #f01843 58.33%, #ed004c 66.67%, #e90057 75%, #e30064 83.33%, #db0071 91.67%, #d10080 100%)"}
                icons={<BarChartIcon />}
              />
            </Grid>
